...
'obscomp=prmsl'
*djf 'magobscomp=sqrt(atot(pow(prmsl,2),lon=-60,lon=0,lat=30,lat=70))'
...
*north pac. 
'magobscomp=sqrt(atot(pow(prmsl,2),lon=150,lon=240,lat=30,lat=60))'
...
*north pac. 
'cosalpha=scorr(prmsl,obscomp,lon=150,lon=240,lat=30,lat=60)'
...
*north pac. 
'magcomp=sqrt(atot(pow(prmsl,2),lon=150,lon=240,lat=30,lat=60))'
...
*jf nonsym 'magcomp=sqrt(atot(pow(prmsl,2),lon=-40,lon=20,lat=30,lat=75))'
   ...
   cad=val1'       'val2
   rc=write('ensomerge_atm_jf_northpac_fortaylor_nonsym.txt',cad,append)
