...
#NDJ/DJ. years here are for DJF or JF 26 events long 
...
#then I want to put all those anomalies together
   if trial==1:
    print "mv ensocomp.nc ensomerge_djf_perm_long.nc" ##
##
    print "mv elninovar.nc elninovarmerge_djf_perm_long.nc" ##
    print "mv laninavar.nc laninavarmerge_djf_perm_long.nc" ##
   else:
    print "cdo -O merge ensocomp.nc ensomerge_djf_perm_long.nc ensomergenew.nc" ##
    print "mv ensomergenew.nc ensomerge_djf_perm_long.nc" ##
##
    print "cdo -O merge elninovar.nc elninovarmerge_djf_perm_long.nc elninovarmergenew.nc" ##
    print "mv elninovarmergenew.nc elninovarmerge_djf_perm_long.nc" ##
##
    print "cdo -O merge laninavar.nc laninavarmerge_djf_perm_long.nc laninavarmergenew.nc" ##
    print "mv laninavarmergenew.nc laninavarmerge_djf_perm_long.nc" ##
